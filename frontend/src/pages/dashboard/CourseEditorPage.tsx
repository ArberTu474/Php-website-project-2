...
export default function CourseEditorPage() {
  ...
  const handleLessonSave = useCallback(
    (form: LessonFormData) => {
      if (lessonDialog === "create") {
        createLesson.mutate(form)
      } else {
        updateLesson.mutate(form)
      }
    },
    [lessonDialog, createLesson, updateLesson]
  )
    ...
    <div className="container mx-auto my-0 px-6 py-3">
      <div className="mt-6 space-y-2">
        <div className="flex items-center gap-2">
          ...
          <Badge className="leading-none" variant={course.is_published ? "secondary" : "destructive"}>
        ...
        {course.modules?.map((module: Module) => (
          ...
          >
            <div className="flex items-start justify-between gap-2 border-t border-border bg-muted/50 px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                <Button size="icon" variant="outline" onClick={() => openEditModule(module)}>
                  <SquarePen />
                </Button>
                ...
                <Button
                  ...
                  onClick={() => {
                    if (
                      confirm(`Delete module "${module.title}" and all its lessons?`)
                    ) {
      ...
      <Dialog open={moduleDialog !== null} onOpenChange={(open) => !open && setModuleDialog(null)}>
        <DialogContent className="sm:max-w-[700px]">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                className="min-h-[160px] resize-none overflow-y-scroll"
                rows={10}
                onChange={(e) =>
          ...
          <DialogFooter>
            <Button size="lg" variant="outline" onClick={() => setModuleDialog(null)}>
              Cancel
            </Button>
            <Button
              size="lg"
